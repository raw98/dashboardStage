...
export class BarChartService {
  ...
  getBarChiffre(continent: string, region: string, year: number, week: number, day: string, article: string, client: string, fournisseur:string, magazin: string):Observable<BarChart[]>{
